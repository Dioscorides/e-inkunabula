...
# NOTE modified from original inkycal code.
# 1.81 is the VCOM for this specific 9.7" display in our possession. The default value is set to 2.00.
# That is a 9.4% difference in voltage which might be enough to cause ghosting and damage the display.
