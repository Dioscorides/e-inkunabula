...
class Inkycal:
    ...
    def __init__(self, settings_path=None, render=True):
        ...
        self.optimize = False
        print('optimization:', self.optimize)
    ...
    def _assemble(self):
        ...
        # NOTE: modifed from original inkycal to render black as RGB instead of L
